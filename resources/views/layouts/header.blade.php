...
<div class="sidebar-inner slimscrollleft">
    <div id="sidebar-menu">
        <ul>
                      ...
                      <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-google-pages"></i><span>Shope <span class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                <ul class="list-unstyled">
                    <li><a href="{{url('category')}}">Category</a></li>
                    <li><a href="{{url('sub-category')}}">Sub-Category</a></li>
                    <li><a href="{{url('product-type')}}">Product Type</a></li>
                    <li><a href="{{url('brand')}}">Brands</a></li>
                    <li><a href="{{url('items')}}">Products</a></li>
                </ul>
            </li>
            ...
            <li>
                <a href="faq" class="waves-effect"><i class="mdi mdi-help-circle"></i><span> FAQ </span></a>
            </li>
            <li>
                <a href="contact" class="waves-effect"><i class="mdi mdi-headset"></i><span> Contact <span class="badge badge-pill badge-warning pull-right">3</span> </span></a>
            </li>
            <li>
